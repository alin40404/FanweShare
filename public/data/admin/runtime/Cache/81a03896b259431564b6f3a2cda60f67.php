...
<table cellpadding="4" cellspacing="0" border="0" class="table-form">
	<tr>
		<th width="200"><?php echo L("TIPS");?></th>
		<td>
			<p><?php echo L("ROLENODE_TIPS");?></p>
		</td>
	</tr>
	<tr>
		<th><?php echo L("ACTION");?></th>
		<td><input type="text" class="textinput" name="action" />&nbsp;<span><?php echo L("ACTION_TIPS");?></span></td>
	</tr>
	<tr>
		<th><?php echo L("ACTION_NAME");?></th>
		<td><input type="text" class="textinput" name="action_name" /></td>
	</tr>
	<tr>
		<th><?php echo L("MODULE");?></th>
		<td><input type="text" class="textinput requireinput" name="module" />&nbsp;<span><?php echo L("MODULE_TIPS");?></span></td>
	</tr>
	<tr>
		<th><?php echo L("MODULE_NAME");?></th>
		<td><input type="text" class="textinput" name="module_name" /></td>
	</tr>
	<tr>
		<th><?php echo L("NAV_ID");?></th>
		<td>
			<select id="nav_id" name="nav_id" onchange="" ondblclick="" class="" ><option value="" ><?php echo L("SELECT_NAV_ID");?></option><?php  foreach($nav_list as $key=>$val) { ?><option value="<?php echo $key ?>"><?php echo $val ?></option><?php } ?></select>
		</td>
	</tr>
	<tr>
		<th><?php echo L("IS_SHOW");?></th>
		<td>
			<label><input type="radio" name="is_show" value="1" checked="checked" /><span><?php echo L("YES");?></span></label>
			<label><input type="radio" name="is_show" value="0"/><span><?php echo L("NO");?></span></label>
		</td>
	</tr>
	<tr>
		<th><?php echo L("SORT");?></th>
		<td><input type="text" class="textinput" name="sort" size="4" value="10"/></td>
	</tr>
	<tr class="act">
		<th>&nbsp;</th>
		<td>
